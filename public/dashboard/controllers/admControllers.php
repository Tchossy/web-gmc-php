...
if ($type_form == 'login_adm') {
  ...
  if (!empty($dataForm['email_address_adm']) && !empty($dataForm['login_password_adm'])) {
    ...
    if ($result_adm->rowCount() < 1) {
      unset($_SESSION['adm_gmc_name']);
      unset($_SESSION['adm_gmc_email']);
      unset($_SESSION['adm_gmc_permissions']);
      ...
      $_SESSION['adm_gmc_name'] = $adm_name;
      $_SESSION['adm_gmc_email'] = $email_address_adm_form;
      $_SESSION['adm_gmc_permissions'] = $permissions_adm;
