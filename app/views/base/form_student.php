...
<div class="heroContainerStyles">
  ...
  <div class="infoHero">
    <div class="path">
      ...
      <p> > </p>
      <p> Equipas de Estudantes </p>
    </div>

    <h1 data-aos="zoom-in-up">Ficha de Inscrição - Equipas de Estudantes</h1>
  </div>
            ...
            <div class="row">
              ...
              <div class="col-md-12 p-sm-0" hidden>
                <div class="form-group">
                  ...
                  <input name="type_team" id="type_team" value="Equipa de Estudantes" type="text" class="form-control"
