            ...
            <div class="ugf-container">
              <div class="ugf-form-block">
                <div class="ugf-form-wrap">
                  <img style="width: 22rem; margin: -1.8rem 0 3rem;" src="<?= DASHBOARD_IMG . "/logo-dark.png" ?>" class="img-fluid" alt="">

                  <span class="marker-icon">
                    <img src="<?= DASHBOARD_IMG . "/marker-user.png" ?>" alt="">
                  </span>
                  <div>
                    <h3 style="text-align: center;">Painel - GMC</h3>
                    <p style="margin: -2.8rem 0 3rem; text-align: center;">Sistema Integrado Global Management Challenge
                    </p>
                  </div>
